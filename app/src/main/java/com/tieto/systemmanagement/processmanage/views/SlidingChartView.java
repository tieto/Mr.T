...
public class SlidingChartView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.SlidingChartView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.SlidingChartView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.SlidingChartView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.SlidingChartView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.SlidingChartView_exampleDrawable);
