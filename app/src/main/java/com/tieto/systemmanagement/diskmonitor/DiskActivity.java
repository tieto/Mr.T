...
public class DiskActivity  extends BasicTabbedActivity {
    ...
    protected void onResume() {
        ...
        ts.add(SysManageApplication.getInstance().getString(R.string.disk_space_store));
        ts.add(SysManageApplication.getInstance().getString(R.string.disk_space_system));
